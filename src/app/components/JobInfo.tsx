...
function Jobinfo({ type, title, desc, date }: jobProps) {
  return (
    <div className="flex flex-col items-center justify-around rounded-t-[3rem] rounded-br-[3rem] h-[22rem] lg:max-h-[22rem] w-[95%] lg:w-[45%] xl:w-[45%] group bg-slate-50 hover:scale-105 transition duration-300 cursor-pointer">
